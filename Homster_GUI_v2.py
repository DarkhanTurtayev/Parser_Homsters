...
for page in url_list:
    ...
    link_data = driver.find_elements(By.CLASS_NAME, 'b-snippet__title-link')
...
for selection in dict_links:
    ...
    try:
        ...
        try:
             ...
             name_object = driver.find_element(By.CLASS_NAME, 'b-complex-heading-info__title--big').text
    
        except Exception as _ex:
        
             name_object = None
             
        name_data_n.append(name_object)
...
datacheck = [link_data, name_data_n, min_list, max_list, sqm_data, company_data, city_data, district_data, address_data, full_ad_data, status_data, amount_data, available_data, deadline_data, height_data, floors_data, parking_data, decor_data, class_data, type_data, extra_data]
